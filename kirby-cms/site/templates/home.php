...
<body class="home">
  ...
  <main>
		<section class="first-page">
			<svg class="w-75 pt0 pb5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1603.8 498.3" style="enable-background:new 0 0 1603.8 498.3;" xml:space="preserve">
			<g>
				<g>
      ...
      <div class="wrap wide">
        ...
        <button>
					<a href="<?= page('projects')->url() ?>" class="btn">show all projects</a>
				</button>
      </div>
    </section>
			...
			<section>
				<figure>
					<video loop muted autoplay>
						...
						<source src="../../assets/images/header2.ogv" type="video/ogg">
					</video>
				</figure>
			</section>

			<article>
				<h1>Cactus & CSS mix-blend-mode</h1>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
				<figure>
					<img src="../../assets/images/cactus_PNG2.png" />
					<figcaption>
						<p>
						...
						<footer>
							<time datetime="2017-02-08">8-2-2017</time> © 2017 <a href="https://github.com/s44s/cssttr">Suus ten Voorde</a>
						</footer>
					</figcaption>
				</figure>
			</article>
